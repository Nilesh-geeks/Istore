...
#       else
#         format.html { redirect_to admin_categories_url, alert: "Failed to destroy the category." }
...
#       format.html { redirect_to admin_categories_url, alert: "An unexpected error occurred." }
#       format.json { render json: { error: "An unexpected error occurred." }, status: :internal_server_error }
#     end
#   end
